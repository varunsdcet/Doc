...
        });
    ...
    render() {
      ...
      <View style = {{height:70,backgroundColor:'#639ced',flexDirection:'row',width:window.width,justifyContent:'space-between'}}>
...
<View style = {{flexDirection:'row'}}>
          ...
          <Text style = {{color:'white',fontFamily:GLOBAL.roman,fontSize: 17,marginLeft:0,alignSelf:'center'}} >
                                 {GLOBAL.pname}
                              </Text>

</View>
          <Text style = {{color:'white',fontFamily:GLOBAL.roman,fontSize: 3,marginLeft:-20,alignSelf:'center'}} >
                                 
                              </Text>
