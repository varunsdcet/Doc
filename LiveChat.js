...
        });
    ...
    render() {
      ...
      <View style = {{height:70,backgroundColor:'#639ced',flexDirection:'row',width:window.width}}>
...
<View style = {{marginTop:12}}>
                <Text style = {{color:'white',fontFamily:GLOBAL.roman,fontSize: 18,marginLeft:0,textAlign:'left'}} >
 {GLOBAL.pname}
                                    </Text>
                <Text style = {{color:'white',fontFamily:GLOBAL.roman,fontSize: 14,marginLeft:0,textAlign:'left'}} >
 {this.props.navigation.state.params == "1" ? "Limited Reply":"Unlimited Reply"}
                                    </Text>
                </View>
...
                    onSend={message => {
  ...
  const url = GLOBAL.BASE_URL +  'last_chat_insert_chat_package'
 ...
                              
   ...
                                  }
   ...
   else if (responseJson.end_flag == 1){
      Alert.alert('PACKAGE EXPIRED','This Chat Package has expired. Please purchase another package to continue',
            [{text:"Okay"},
    ...
                                   }
     ...
     Alert.alert('SESSION EXPIRED','The Session has expired',
            [{text:"Okay"},
